...
base_path = f's3://databric-rd/{data_source}'
...
# Drop duplicates for merge keys to avoid Delta merge error
merge_keys = ["order_placement_date", "order_id", "product_code", "customer_id"]
df_joined = df_joined.dropDuplicates(merge_keys)
